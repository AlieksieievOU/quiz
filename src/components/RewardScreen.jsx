    ...
    >
      {rewardType === 'coin' && (
        <div className="coin-anim flex flex-col items-center">
          <img src="/assets/image11-new.png" alt="Coin" className="w-full h-full md:w-100 md:h-100  drop-shadow-2xl mb-8" />
          <h2 className="text-5xl font-bold text-slate-800 drop-shadow-md">+1</h2>
        </div>
      )}
      {rewardType === 'diamond' && (
        <div className="coin-anim flex flex-col items-center">
          <img src="/assets/image7-new.png" alt="Diamond" className="w-full h-full md:w-100 md:h-100  drop-shadow-2xl mb-8" />
      ...
      {rewardType === 'trophy' && (
        <div className="coin-anim flex flex-col items-center text-center">
          ...
          <img src="/assets/win_transparent-new.png" alt="Trophy" className="w-full h-full md:w-100 drop-shadow-2xl mb-8" />
          <button
            onClick={onRestart}
